...
Bogart.App = function(options) {
    ...
    var app = function(env) {
        ...
        try {
            ...
            this.publish("route_error", this, err, { verb: verb, path: this.request.relativeURI() });
...
["addPlugin","removePlugin","subscribeTo","unsubscribe","plugins"].forEach(function(method) {
