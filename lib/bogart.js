...
exports.request = function(router, jsgiReq) {
  var
    ...
    isxhr         = !util.no(requestedWith),
    parsedBody    = when(util.no(jsgiReq.body) ? '' : jsgiReq.body.join(), function(body) { return require('querystring').parse(body); }),
...
exports.router = function(config, notFoundApp) {
  var
    ...
    router = Object.create(new Router.Router(), {
