...
Bogart.App = function(options) {
    ...
    publish("before_init", this, options);
    ...
    this.getRouteHandler = function(verb, path) {
        ...
        publish("before_lookup_route", verb, path);
        ...
        publish("after_lookup_route", routed, verb, path);
    ...
    this.handleRoute = function(verb, path, params) {
        ...
        publish("before_execute_route", routeContext);
        var result =  route.callback.call(routeContext);
        publish("after_execute_route", routeContext);
...
Bogart.App.prototype.subscribers = {};
 ...
 */
Bogart.App.prototype.subscribeTo = Bogart.App.subscribeTo = function(event, callback){
    Bogart.App.prototype.subscribers[event] = Bogart.App.prototype.subscribers[event] || [];
    Bogart.App.prototype.subscribers[event].push(callback);
};
