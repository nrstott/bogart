...
var _global = system.global;

this.Bogart = exports.Bogart = {
    noConflict: function() {
        ROUTE_VERBS.forEach(function(verb) {
            _global[verb] = globalsCache[verb];
        });
        _global.route = globalsCache.route;
    }
};
...
ROUTE_VERBS.forEach(function(verb){
    this[verb] = function(path, callback) {
        __app__[verb](path, callback);
    };
});

route = function(verb, path, callback) { __app__.route(verb, path, callback); };
