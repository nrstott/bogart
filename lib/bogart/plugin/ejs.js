    ...
    this.callbacks = {
        before_execute_route: function(app, routeHandlerContext) {
            ...
            routeHandlerContext.ejs = function(viewName, model, options){
                ...
                var renderer = new EjsLayoutRenderer(layoutTemplate, routeHandlerContext.env, templateLocator);
                ...
                this.publish(Ejs.Event.AFTER_RENDER, page);

                this.publish(Ejs.Event.BEFORE_WRITE_RESPONSE, routeHandlerContext.response, page);
                routeHandlerContext.response.write(page);
                this.publish(Ejs.Event.AFTER_WRITE_RESPONSE, routeHandlerContext.response);
