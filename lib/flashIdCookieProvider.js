...
exports.getFlashId = function(req) {
    if (req.headers && req.headers.cookie && req.headers.cookie[flashCookieName]) {
        return security.decrypt(req.headers.cookie[COOKIE_KEY]);
    } else return null;
};
...
exports.finalize = function(req, res, flashId) {
    ...
    var cookie = flashCookieName + "=" + security.encrypt(flashId);
