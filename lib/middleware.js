...
exports.parseForm = exports.ParseForm = function(req, nextApp) {
    var contentType = req.headers['content-type'];
...
exports.gzip = exports.Gzip = function(req, nextApp) {
 ...
 */
exports.methodOverride = exports.MethodOverride = function(request, nextApp) {
...
exports.parted = exports.Parted = function(req, nextApp, opts) {
 ...
 */
exports.error = exports.Error = function(req, app, errorResponse) {
