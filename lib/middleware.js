...
exports.batteries = function(config) {
    ...
    return function(req, nextApp) {
        ...
        return stack(exports.error, exports.gzip, exports.directory(config.root), exports.parted, exports.methodOverride,
          exports.session(), exports.flash(), exports.bodyAdapter, exports.stringReturnAdapter);
    };
};
