...
/**
 * Construct a binary split middleware with the signature
 * `function(req, appTrue, appFalse)`
 *
 * If `conditional` returns `true`, then `appTrue` is executed. Otherwise, `appFalse` is executed.
 *
 * Example:
 * 
 *     var splitter = bogart.middleware.binary(function(req) { return req.method === 'GET'; });
 ...
 */
exports.binary = function(conditional) {
  var bogart = require('./bogart')
    , ifTrue = bogart.chain()
