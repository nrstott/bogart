 ...
 */
exports.bodyAdapter = function(req, nextApp) {
  return when(nextApp(req), function(resp) {
 ...
 * @returns {Function} JSGI Application.
 */
exports.stringReturnAdapter = function(req, nextApp) {
  ...
  return when(nextApp(req), function(resp) {
    console.log('sra resp', resp);
    if (typeof resp === 'string') {
      console.log('found string resp', resp);
