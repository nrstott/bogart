...
middleware.parseJson = middleware.ParseJson = function(nextApp) {
  return function(req) {
...
middleware.gzip = middleware.Gzip = function(nextApp) {
 ...
 */
middleware.methodOverride = middleware.MethodOverride = function(nextApp) {
 ...
 * @returns {Function} JSGI response.
 */
middleware.validateResponse = middleware.ValidateResponse = function(nextApp) {
  return function(req) {
...
var HTTP_METHODS = middleware.HTTP_METHODS = {
  "GET": true,
  "HEAD": true,
  "PUT": true,
  "POST": true,
...
var METHOD_OVERRIDE_PARAM_KEY = middleware.METHOD_OVERRIDE_PARAM_KEY = "_method";
var HTTP_METHOD_OVERRIDE_HEADER = middleware.HTTP_METHOD_OVERRIDE_HEADER = "x-http-method-override";
