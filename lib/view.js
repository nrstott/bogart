...
exports.viewEngine = function(engineName, views, opts) {
  return Object.create(new ViewEngine(), {
    ...
    views: { value: views || path.join(settings('template directory')), enumerable: true, readonly: true },
    viewCache: { value: {} },
...
ViewEngine.prototype.respond = function(view, opts) {
  ...
  return when(this.render(view, opts), function(str) {
    return {
      ...
      headers: opts.headers || { 'content-type': 'text/html', 'content-length': str.length },
      body: [str]
    };
  });
};
...
exports.viewEngine.addEngine('mustache', function(str, opts) {
